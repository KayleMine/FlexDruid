...
dark_addon.rotation.spellbooks.GITwarlock = {
  Agony = 980,
...
dark_addon.rotation.spellbooks.GITwarrior = {
    Avatar = 107574,
    Skullsplitter = 260643,
    BattleCry = 1719,
    BerserkerRage = 18499,
...
dark_addon.rotation.spellbooks.GITshaman = {
...
dark_addon.rotation.spellbooks.GITrogue = {
...
dark_addon.rotation.spellbooks.GITpriest = {
  ArcaneInt = 1459,
  AngelicFeather = 121536,
  Apotheosis = 200183,
  Atonement = 194384,
...
dark_addon.rotation.spellbooks.GITpaladin = {
  Absolution = 212056,
  AegisofLight = 204150,
...
dark_addon.rotation.talentbooks.GITpaladin = {
  Zeal = {1, 1},
...
dark_addon.rotation.spellbooks.GITmonk = {
-- Mistweaver
BlackoutKick = 100784,
...
--adddadadadadad
dark_addon.rotation.spellbooks.GITmage = {
  WorldveinRes = 295186,
  ArcaneInt = 1459,
  ...
  Combustion = 190319,
  ConcentradedFlame = 295373,
  AzeriteGuardian = 295840,
  Ripple = 302731,
  Counterspell = 2139,
  GladMed = 208683,
  RemoveCurse = 475,
...
dark_addon.rotation.spellbooks.GIThunter = {
    -- GENERAL
    -- Used In Rotation
    PreciseShots = 260242,
...
dark_addon.rotation.spellbooks.GITdruid = {
...
dark_addon.rotation.dispellbooks.GITsoothe = {
	-- Soothe
	[228318] = "Raging", -- Raging Affix	All	-	No	+100% damage dealt
	[255824] = "Fanatic's Rage", -- Dazar'ai Juggernaut	Atal'Dazar	12	Yes	+50% attack speed +20% dmg dealt, -50% mvespd
	[257476] = "Bestial Wrath", -- Irontide Mastiff	Freehold	60	No	+50% damage dealt
...
dark_addon.rotation.spellbooks.GITdemonhunter = {
  --- Racials
...
--um
dark_addon.rotation.talentbooks.GITdemonhunter = {
  --- Vengeance
  AbyssalStrike = {1, 1},
  AgonizingFlames = {1, 2},
  RazorSpikes = {1, 3},
...
dark_addon.rotation.spellbooks.GITdeathknight = {
  ArcaneTorrent = 50613,
  ArmyOfTheDead = 42650,
  AntiMagicShell = 48707,
  Apocalypse = 275699,
...
dark_addon.rotation.spellbooks.GITpurgeables = {
  [255579] = "Gilded Claws",
  [257397] = "Healing Balms",
  [270901] = "Induced REgeneration",
  [273432] = "Bound by Shadow",
